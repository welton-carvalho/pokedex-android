...
| Tela | Node ID | URL |
|---|---|---|
| Styleguide | `913:238` | fileKey `ZhswWnNVkMM5mjIYB1M554` |
| Components | `913:239` | fileKey `ZhswWnNVkMM5mjIYB1M554` |
| List (sort by number) | `1017:431` | fileKey `ZhswWnNVkMM5mjIYB1M554` |
| List (sort card) | `1024:1979` | fileKey `ZhswWnNVkMM5mjIYB1M554` |
| Detail (Bulbasaur) | `1016:1461` | fileKey `ZhswWnNVkMM5mjIYB1M554` |

Para buscar contexto de design: `get_design_context(fileKey, nodeId)` com nodeId usando `:` (não `-`).
...
|---|---|---|
| 1 — Fundação | ✅ Done | build-logic, libs.versions.toml, settings, 16 módulos |
| 2 — Core | ✅ Done | model, common, domain, navigation, observability, design-system, ui |
| 3 — Data | ⬜ Pending | network, local (ObjectBox), repository |
| 4 — App Shell | ⬜ Pending | Application, Koin init, Splash, MainActivity + NavGraph |
| 5 — pokemon-list | ⬜ Pending | MVI completo + Paging3 |
| 6 — pokemon-detail | ⬜ Pending | MVI + artwork + stats |
| 7 — core:testing | ⬜ Pending | fakes, helpers |
| 8 — Testes | ⬜ Pending | unit, integration, UI |
| 9 — Polish | ⬜ Pending | @Immutable, Coil cache, proguard |
